...
ALPAKA_FN_ACC auto inline UpdateVolumesForElems_device(Index_t numElem, Real_t v_cut, 
                                  Real_t *vnew,
                                  Real_t *v,
                                  Index_t i)
{
...
ALPAKA_FN_ACC auto inline CalcSoundSpeedForElems_device(Real_t& vnewc, Real_t rho0, Real_t &enewc, 
